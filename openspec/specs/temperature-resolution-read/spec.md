# Spec: Temperature Resolution Read

## Purpose

Defines the `read_with_temperature()` method on the ABP driver, which reads pressure and optionally temperature with caller-chosen resolution via the embedded-hal v1.0 I2C trait.
