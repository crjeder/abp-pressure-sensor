...
Defines the `PressureRange` enum representing all valid Honeywell ABP orderable pressure ranges (as listed in the datasheet, Figure 3 / Table 7), together with methods to retrieve pressure bounds in Pascals and the associated unit.
